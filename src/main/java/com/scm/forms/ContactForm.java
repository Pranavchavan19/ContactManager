...
//     public ContactForm(String name, String email, String phoneNumber, String address,
//                        String description, boolean favorite, String websiteLink,
//                        String linkedInLink, MultipartFile contactImage, String picture) {
//         this.name = name;
//         this.email = email;
